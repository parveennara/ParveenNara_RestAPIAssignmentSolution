...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers(HttpMethod.GET, "/api/employees/*", "/api/employees/list", "/api/employees/search/*", "/api/employees/sort").hasAnyAuthority("USER","ADMIN")
		...
		.antMatchers(HttpMethod.POST, "/api/roles/add", "/api/users/add").permitAll()
